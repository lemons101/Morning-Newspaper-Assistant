...
from morning_v2.collectors import collect_all
from morning_v2.common import load_yaml, write_json, write_text
from morning_v2.models import utc_now_iso


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Collect raw v2 morning newspaper cards.")
